...
Status: NOT AVAILABLE (auto-skip)
Targets evaluated: 8 | Targets with a predicted route: 0/8 (0 PREDICTED_ROUTE rows: up to 3 ranked routes per target)
...
No route predictions written (models absent).
